      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden sm:block">
            <input type="text" placeholder="Search" className="bg-gray-100 border border-gray-300 rounded-lg px-4 py-1.5 text-sm w-64 focus:outline-none focus:ring-2 focus:ring-blue-400" />
          </div>
          <div className="flex items-center space-x-4">
            ...
            <button><ProfileIcon avatarUrl="https://placehold.co/150x150/1d3557/ffffff?text=Me" /></button>
          </div>
        </div>
      </div>
    </nav>
