        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-16">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-2">
                <Link href="/settings/edit-profile" className="px-8 py-1.5 bg-gray-100 hover:bg-gray-200 rounded-lg font-semibold text-sm text-gray-900 transition-colors">
                  Edit profile
                </Link>
                ...
                <Link href="/settings/edit-profile" className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
